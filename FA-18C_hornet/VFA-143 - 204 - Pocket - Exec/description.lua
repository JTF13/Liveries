livery = {
	--Main Maps
	{"f18c1", 0 ,"F18C_1_DIFF_VFA143_PukinDogs_Line",false};
	{"f18c1", ROUGHNESS_METALLIC ,"F18C_1_DIF_RoughMet",true};

	{"f18c2", 0 ,"F18C_2_DIFF_VFA143_PukinDogs_Line",false};
	...
	{"pilot_F18_helmet_hmd", 0 ,"../VFA-143Textures/pilot_F18_helmet_pocket",false};
	...
	--Fuel Tanks
	{"FPU_8A", 0 ,"../VFA-143Textures/FPU_8A_PukinDogs_CO",false};
...
name = "VFA-143 Pukin' Dogs - 204 - Pocket - Exec"
