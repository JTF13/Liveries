...
-- ch-47f_tex16_DECAL
	{"ch-47f_tex16_DECAL", 0, "ch-47f_tex16",	true};
	{"ch-47f_tex16_DECAL", 1, "ch-47f_tex16_NRM",	true};
	{"ch-47f_tex16_DECAL", ROUGHNESS_METALLIC, "ch-47f_tex16_RoughMet", true};
	{"ch-47f_tex16", DECAL, "ch-47f_decal",	false};

-- ch-47f_tex17
	{"ch-47f_tex17", 0, "ch-47f_tex17",	true};
	{"ch-47f_tex17", 1, "ch-47f_tex17_NRM",	true};
	{"ch-47f_tex17", ROUGHNESS_METALLIC, "ch-47f_tex17_RoughMet", true};

-- Pilot
	{"Pilot_CH47_FP_Jacket",DIFFUSE			,	"../1-52 GSAB-2012/pilot_ch47_fp_jacket", false};
	{"Pilot_CH47_FP_Jacket",NORMAL_MAP		,	"../1-52 GSAB-2012/pilot_ch47_fp_jacket_normal", false};
	{"Pilot_CH47_FP_Jacket",ROUGHNESS_METALLIC,	"../1-52 GSAB-2012/pilot_ch47_fp_jacket_roughmet", false};
	{"Pilot_CH47_Patch",DIFFUSE				,	"../1-52 GSAB-2012/pilot_ch47_patch", false};
	{"Pilot_CH47_Patch",NORMAL_MAP			,	"../1-52 GSAB-2012/pilot_ch47_patch_normal", false};
	{"Pilot_CH47_Patch",ROUGHNESS_METALLIC	,	"../1-52 GSAB-2012/pilot_ch47_patch_roughmet", false};
}

name = "1-52 GSAB 16th Combat Aviation Brigade 'Sugar Bear-2017'"
