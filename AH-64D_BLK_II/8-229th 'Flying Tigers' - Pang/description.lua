livery = {
	...
	{"AH-64D_front",	    			0,			"AH-64D_front_Pang",               															false};
	{"AH-64D_front_RoughMet",	    	0,			"AH-64D_front_RoughMet_Pang",               												false};
	...
	{"ah-64d_cpt14",			  DIFFUSE,			"ah-64d_cpt14_Dashboard_Pang", 															false};
}

name = "8-229th 'Flying Tigers' - Pang"
countries = {"USA",}
