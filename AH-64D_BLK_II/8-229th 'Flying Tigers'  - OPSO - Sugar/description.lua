livery = {
	...
	{"AH-64D_front",	    			0,			"AH-64D_front_OPSO_Sugar",               													false};
	{"AH-64D_front_RoughMet",	    	0,			"AH-64D_front_RoughMet_OPSO_Sugar",               											false};
	...
	{"ah-64d_cpt14",			  DIFFUSE,			"ah-64d_cpt14_Dashboard_Sugar", 															false};
}

name = "8-229th 'Flying Tigers' - OPSO - Sugar"
countries = {"USA",}
