livery = {
	...
	{"AH-64D_front",	    			0,			"AH-64D_front_XO_Ruiner",               													false};
	{"AH-64D_front_RoughMet",	    	0,			"AH-64D_front_RoughMet_XO_Ruiner",               											false};
	
	{"AH-64D_engine_1",	    			0,			"AH-64D_engine_1_FT5",               													    false};
	{"AH-64D_engine_1_RoughMet",	    0,			"AH-64D_engine_1_RoughMet_FT5",              												false};
	...
	{"ah-64d_cpt14",			  DIFFUSE,			"ah-64d_cpt14_Ruiner", 																		false};
}

name = "8-229th 'Flying Tigers' - XO - Ruiner"
countries = {"USA",}
