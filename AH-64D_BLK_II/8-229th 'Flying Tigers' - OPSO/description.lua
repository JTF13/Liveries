livery = {
	...
	{"AH-64D_balka_2",	    			0,			"AH-64D_balka_2_FT4",               														false};
	{"AH-64D_balka_2_RoughMet",	    	0,			"AH-64D_balka_2_RoughMet_FT4",            												   	false};
	
	{"AH-64D_front",	    			0,			"../8-229th 'Flying Tigers' - Common Textures/AH-64D_front_FT",               				false};
	{"AH-64D_front_RoughMet",	    	0,			"../8-229th 'Flying Tigers' - Common Textures/AH-64D_front_RoughMet_FT",               		false};
	
	{"AH-64D_engine_1",	    			0,			"AH-64D_engine_1_FT4",               														false};
	{"AH-64D_engine_1_RoughMet",	    0,			"AH-64D_engine_1_RoughMet_FT4",              												false};
...
name = "8-229th 'Flying Tigers' - OPSO"
countries = {"USA",}
