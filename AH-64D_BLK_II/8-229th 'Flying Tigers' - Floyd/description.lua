livery = {
	...
	{"AH-64D_front",	    			0,			"AH-64D_front_Floyd",               															false};
	{"AH-64D_front_RoughMet",	    	0,			"AH-64D_front_RoughMet_Floyd",               												false};
	...
	{"ah-64d_cpt14",			  DIFFUSE,			"ah-64d_cpt14_Dashboard_Floyd", 															false};
}

name = "8-229th 'Flying Tigers' - Floyd"
countries = {"USA",}
