livery = {
	...
	{"AH-64D_front",	    			0,			"AH-64D_front_Uncle",               															false};
	{"AH-64D_front_RoughMet",	    	0,			"AH-64D_front_RoughMet_Uncle",               												false};
	...
	{"ah-64d_cpt14",			  DIFFUSE,			"ah-64d_cpt14_Dashboard_Uncle", 															false};
}

name = "8-229th 'Flying Tigers' - Uncle"
countries = {"USA",}
