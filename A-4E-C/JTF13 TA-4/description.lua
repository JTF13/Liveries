...
livery = {
  ...
  {"tail_100", DIFFUSE, "empty", true};
   ...
   {"fuel_150_a4e", 0, "300_150_tanks", false};
   {"fuel_150_a4e", 2, "300_150_tanks", false};
   {"fuel_150_a4e", 12, "300_150_tanks", false};

   -- custom fuel tank: 300 gallon left/right
   {"fuel_300lr_a4e", 0, "300_150_tanks", false};
   {"fuel_300lr_a4e", 2, "300_150_tanks", false};
   {"fuel_300lr_a4e", 12, "300_150_tanks", false};

    -- custom fuel tank: 300 gallon center
    {"fuel_300c_a4e", 0, "300_150_tanks", false};
    {"fuel_300c_a4e", 2, "300_150_tanks", false};
    {"fuel_300c_a4e", 12, "300_150_tanks", false};
}
