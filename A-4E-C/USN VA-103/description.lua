...
livery =
{
    {"Bottom", 0, "va103_bot", false};
    {"Top", 0, "va103_top", false};
    ...
    {"fuel_150_a4e", 0, "va103_dt150_300", false};
    {"fuel_150_a4e", 2, "va103_dt150_300", false};
    {"fuel_150_a4e", 12, "va103_dt150_300", false};

    -- custom fuel tank: 300 gallon left/right
    {"fuel_300lr_a4e", 0, "va103_dt150_300", false};
    {"fuel_300lr_a4e", 2, "va103_dt150_300", false};
    {"fuel_300lr_a4e", 12, "va103_dt150_300", false};

    -- custom fuel tank: 300 gallon center
    {"fuel_300c_a4e", 0, "va103_dt150_300", false};
    {"fuel_300c_a4e", 2, "va103_dt150_300", false};
    {"fuel_300c_a4e", 12, "va103_dt150_300", false};

    -- custom fuel tank: 400 gallon
    {"fuel_400_a4e", 0, "va103_dt400", false};
    {"fuel_400_a4e", 2, "va103_dt400", false};
    {"fuel_400_a4e", 12, "va103_dt400", false};
